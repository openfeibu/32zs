<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/user\grade.html";i:1491412426;s:79:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\head_center.html";i:1492949210;s:74:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\footer.html";i:1492949210;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
       ...
       <div class="myexam">
           ...
           <table width="800" style="margin:0 auto;border-radio:5px;">
                <tr class="line-table-height" style="color:#333;font-size:16px;background:#971f21;color:#fff;line-height:35px">
                   <td class="k-s-content"  width="40%">专业</td>
                   <td class="k-s-content" >成绩</td>
               </tr>
               <?php if(!empty($user['major_score'])): if(is_array($major_score_key) || $major_score_key instanceof \think\Collection || $major_score_key instanceof \think\Paginator): if( count($major_score_key)==0 ) : echo "" ;else: foreach($major_score_key as $k=>$v): ?>
               <tr class="line-table-height">
                   <td class="k-s-content"  width="40%"><?php echo $v; ?></td>
                   <td class="k-s-content" ><?php echo $major_score_arr[$k]; ?></td>
               </tr>
               ...
               <tr class="line-table-height">
                   ...
                   <td class="k-s-content" ><?php if(!empty($user['recruit_score'])): ?><?php echo $user['recruit_score']; else: ?>待录入<?php endif; ?></td>
               </tr>
               <tr class="line-table-height">
