<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/wechat\view\we\mats_edit.html";i:1489327654;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1493050510;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1492917079;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1492917366;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1492917366;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('wechat/We/mats_runedit'); ?>"  enctype="multipart/form-data">
					<input type="hidden" name="mats_id" value="<?php echo $mats_list['mats_id']; ?>" />
					<input type="hidden" name="mats_type" value="<?php echo $mats_list['mats_type']; ?>" />
					<input type="hidden" name="news_index" value="<?php echo $mats_list['news_index']; ?>" />
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 标题：  </label>
						<div class="col-sm-10">
							<input type="text" name="mats_title" value="<?php echo $mats_list['news_content']['title']; ?>"   class="col-xs-10 col-sm-6" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="mats_author" value="<?php echo $mats_list['news_content']['author']; ?>"   class="col-xs-10 col-sm-6" />
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resone"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="mats_digest" value="<?php echo $mats_list['news_content']['digest']; ?>"   class="col-xs-10 col-sm-6" />
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resone"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<textarea name="mats_content" rows="100%" style="width:100%" id="myEditor"><?php echo $mats_list['news_content']['content']; ?></textarea>
							<script type="text/javascript">
								var editor = new UE.ui.Editor({
									serverUrl:"<?php echo url('admin/Ueditor/upload',['edit_type'=>'mats']); ?>"
								});
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="mats_content_source_url" value="<?php echo $mats_list['news_content']['content_source_url']; ?>"   class="col-xs-10 col-sm-6" />
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resone"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="mats_thumb_media_id" value="<?php echo $mats_list['news_content']['thumb_media_id']; ?>"   class="col-xs-10 col-sm-6" />
							<span class="help-inline col-xs-12 col-sm-7">
								<span class="middle" id="resone"></span>
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="padding-top:5px;">
							<input name='mats_show_cover_pic' <?php if($mats_list['news_content']['show_cover_pic'] == 1): ?>checked<?php endif; ?>  value='1' class='ace ace-switch ace-switch-4 btn-flat' type='checkbox' />
