<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:68:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/wechat\view\we\reply_list.html";i:1489327654;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1493050510;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1492917079;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1492917366;s:73:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/wechat\view\we\ajax_reply_list.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1492917366;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="navbar" class="navbar navbar-default navbar-fixed-top">
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			...
			<span class="admin_title_span"><?php echo $admin['title']; ?></span>
		</div><!-- 导航左侧正常样式结束 -->
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm2" name="leftnav" method="post" action="<?php echo url('wechat/We/reply_alldel'); ?>" >
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody id="ajax-data">
								<?php if(is_array($reply_list) || $reply_list instanceof \think\Collection || $reply_list instanceof \think\Paginator): if( count($reply_list)==0 ) : echo "" ;else: foreach($reply_list as $key=>$v): ?>
	<tr>
		<td class="hidden-xs" align="center">
			<label class="pos-rel">
				<input name='we_reply_id[]' id="navid" class="ace"  type='checkbox' value='<?php echo $v['we_reply_id']; ?>'>
				<span class="lbl"></span>
			</label>
		</td>
		<td><?php echo $v['we_reply_id']; ?></td>
		<td><?php echo $v['we_reply_key']; ?></td>
		<td><?php echo $v['we_reply_type']; ?></td>
		<?php switch($v['we_reply_type']): case "news": ?>
				<td><?php echo subtext($v['we_replynews'],40); ?>
			...
			<?php break; case "image": ?>
				<td><?php echo $v['we_replyimage_mediaid']; ?></td>
			<?php break; case "voice": ?>
				<td><?php echo $v['we_replyvoice_mediaid']; ?></td>
			<?php break; default: ?>
				<td><?php echo $v['we_replytext_content']; ?></td>
		<?php endswitch; ?>	
		<td class="hidden-sm hidden-xs"><?php echo date('Y-m-d H:i:s',$v['we_reply_addtime']); ?></td>
		<td>
			<?php if($v['we_reply_open'] == 1): ?>
				<a class="red open-btn" href="<?php echo url('wechat/We/reply_state'); ?>" data-id="<?php echo $v['we_reply_id']; ?>" title="已开启">
					<div><button class="btn btn-minier btn-yellow">开启</button></div>
				</a>
				<?php else: ?>
				<a class="red open-btn" href="<?php echo url('wechat/We/reply_state'); ?>" data-id="<?php echo $v['we_reply_id']; ?>" title="已禁用">
		...
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a class="green replyedit-btn" href="<?php echo url('wechat/We/reply_edit'); ?>" data-id="<?php echo $v['we_reply_id']; ?>" data-toggle="tooltip" title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
				<a class="red confirm-rst-url-btn" href="<?php echo url('wechat/We/reply_del',array('we_reply_id'=>$v['we_reply_id'])); ?>" data-info="您确定要删除吗？" data-toggle="tooltip" title="删除">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('wechat/We/reply_edit'); ?>" data-id="<?php echo $v['we_reply_id']; ?>" class="tooltip-success replyedit-btn" data-rel="tooltip" title="修改" data-original-title="修改">
										<span class="green">
						...
						<li>
							<a href="<?php echo url('wechat/We/reply_del',array('we_reply_id'=>$v['we_reply_id'])); ?>"  data-info="您确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="删除" data-original-title="删除">
										<span class="red">
	...
	<?php if($v['we_reply_type'] == 'news'): ?>
	<tr class="detail-row">
		<td colspan="10">
			<div class="row">
				<label class="form-label col-xs-1 text-right">回复内容：</label>
				<div class="formControls col-xs-11">
					<textarea  name="" readonly="readonly" cols="" rows="8" class="col-xs-12"   id="form-field-9"  maxlength=""><?php echo var_export(json_decode($v['we_replynews'],true)); ?></textarea>
				</div>
			</div>
		</td>
	</tr>
...
<tr>
	...
	<td colspan="8" align="right"><?php echo $page; ?></td>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<form class="form-horizontal ajaxForm2" name="we_reply_runadd" id="we_reply_runadd" method="post" action="<?php echo url('wechat/We/reply_runadd'); ?>">
		...
		<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="we_reply_runedit" id="we_reply_runedit" method="post" action="<?php echo url('wechat/We/reply_runedit'); ?>">
