...
class Subject extends Base
{
    ...
    public function subject_list()
    {
        ...
        foreach ($school_list as $school_key => $school)
        {
            ...
            $major_list = MajorModel::get_secondary_vocat_major_list($major_id_arr,$school['school_id']);  //关键
    ...
    public function subject_edit()
    {
        ...
        $major = MajorModel::get_major_detail1($major_id,$enrollment['school_id'],$enrollment['year']);
        if(!$major)
        {
            $this->error('不存在该中职专业');
        }
