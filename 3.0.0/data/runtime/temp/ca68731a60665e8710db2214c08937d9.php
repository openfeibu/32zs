<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/school/school_list.html";i:1525763652;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="fb-add">
				<a href="<?php echo url('admin/School/school_add'); ?>" class="fb-transition">
						添加中职学校
				</a>
			</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('/admin/school/school_delall'); ?>" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($school_list) || $school_list instanceof \think\Collection || $school_list instanceof \think\Paginator): if( count($school_list)==0 ) : echo "" ;else: foreach($school_list as $key=>$v): ?>
								<tr>
									<td  height="28" >
								        <label class="pos-rel">
								            <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['school_id']; ?>">
								            <span class="lbl"></span>
								        </label>
								    </td>
								    <td><?php echo $v['school_id']; ?></td>
									<td height="28" ><a href="<?php echo url('admin/School/school_edit',array('school_id'=>$v['school_id'])); ?>"><?php echo $v['school_name']; ?></a></td>
									<td><?php echo $v['member_count']; ?></td>
									<td>
										<div class=" action-buttons">
											<a class="" href="<?php echo url('admin/School/school_edit',array('school_id'=>$v['school_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-edit bigger-130"></i>																</a>
												<a class=" confirm-rst-url-btn" data-info="确定要删除吗？" href="<?php echo url('admin/School/school_del',array('school_id'=>$v['school_id'])); ?>" title="删除">
