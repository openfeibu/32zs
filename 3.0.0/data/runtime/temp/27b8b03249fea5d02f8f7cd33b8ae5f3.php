<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:78:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/member/sec_vocat_member_list.html";i:1542354287;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:83:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/member/sec_vocat_ajax_member_list.html";i:1526916340;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="">
				<div class="fb-export" style="margin-left: 0px;">
					<a href="<?php echo url('admin/Member/member_export'); ?>" title="导出所有中职考生" class="export_btn">
						导出所有中职考生
					</a>
				</div>
				<div class="fb-export">
					<a href="<?php echo url('admin/Member/member_export_pdf'); ?>" title="导出全部已审核报名表" class="export_btn">
						导出全部已审核报名表
					</a>
				</div>
			...
			<button id="btnsubmit" class="btn-sm ">批量删除</button>
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/Member/member_list'); ?>">
				<div class="fb-state-search  margintop5">
					...
					<select name="activetype_check" class="ajax_change">
						...
						<option value="1" <?php if($activetype_check == '1'): ?>selected="selected"<?php endif; ?>>已审核</option>
...
<tr><td colspan="20"><div class="fb-page"><?php echo $page; ?></div></td></tr>
	...
	<script type="text/javascript">
		...
		$("body").on('click','#downloadpdf',function(){
			...
			// }
			//window.location.href="<?php echo url('admin/Member/member_export_pdf'); ?>?major_id="+major_id;
			window.location.href="<?php echo url('admin/Member/member_export_pdf'); ?>"
		});
