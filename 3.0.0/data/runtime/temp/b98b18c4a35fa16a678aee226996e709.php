<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/examination/index.html";i:1526915351;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1525856357;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div>
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tr>
							<th width="60px"></th>
							<th>高职专业</th>
                            <th width="400px">考场号和考试室 </th>
                            <th width="200px">考试时间</th>
                            <th width="200px">容纳数</th>
                            <th>操作</th>
						</tr>
						</thead>
						...
						<tbody >
                            <tr>
                                ...
                                <td colspan="3">
                                    <div style="width:100%;">
                                        <p style="display:inline-block; width:395px">考场号和考试室</p>
                                        <p style="display:inline-block; width:195px">考试时间</p>
                                        <p style="display:inline-block; ">容纳数</p>
                                    </div>
                                    <div style="width:100%">
                                        <p style="display:inline-block; width:395px">考场号和考试室</p>
                                        <p style="display:inline-block; width:195px">考试时间</p>
                                ...
                                <td>
                        			<div class="hidden-sm hidden-xs action-buttons">
                        				<a class="green"  href="<?php echo url('admin/examination/edit'); ?>" title="修改">
