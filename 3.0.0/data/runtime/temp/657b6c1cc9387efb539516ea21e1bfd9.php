<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:76:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/recruit_score_import.html";i:1542293363;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:81:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/ajax_recruit_score_import.html";i:1542293352;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal ajaxScoreForm" name="excel_runimport" method="post" action="<?php echo url('admin/Score/recruit_score_import'); ?>"  enctype="multipart/form-data">
                    <p>注：请先选择中职学校，点击"下载对应中职考生表格"（只含未审核），录入成绩时请勿修改其他信息；然后点击"选择上传文件"，选择录好成绩的表格，点击"导入"，页面会显示对应上传表格的信息，确认信息无误后，点击页面显示的"确认后提交"。</p>
					<div class="fb-export"><a href="javascript:;" onclick="javascript:var school_id = $('#school_id').val();window.location.href='<?php echo url('admin/Score/recruit_score_export_forimport'); ?>?school_id='+school_id;">下载对应中职技能成绩录入模板</a></div>
            ...
            <div class="row">
    			<div class="col-xs-12">
    				<div>
    					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('admin/Score/recruit_score_runimport'); ?>" >
...
<tr>
    ...
    <td><input type="text" name="recruit_major_score[]" value="<?php echo $v['recruit_major_score']; ?>" class="score_input" data-id="<?php echo $v['member_list_id']; ?>"></td>
</tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
