<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/member/member_edit.html";i:1526051543;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content ">
        ...
        <div class="clearfix form-actions printHide">
            <div class="col-md-offset-3 col-md-9"  href="<?php echo url('admin/Member/member_active'); ?>" data-id="<?php echo $member_list_edit['member_list_id']; ?>">
                <?php if($admin['group_id'] == 1 || $admin['group_id'] == 5): if($member_list_edit['user_status'] == 1): ?>
                <button class="btn btn-info btn-info member_status_btn2 btn-fb-radio" type="button" url="<?php echo url('admin/Member/member_unactive'); ?>">
                    驳回审核
                </button>
                <?php else: ?>
                <button class="btn btn-info btn-primary member_status_btn2 btn-fb-radio" type="button">
                    通过审核
                </button>
                <?php endif; else: if($member_list_edit['user_status'] == 1): ?>
