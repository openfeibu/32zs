<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\admin\secondary_vocat_admin_add.html";i:1493798101;s:56:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\public\base.html";i:1489327654;s:58:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\public\header.html";i:1494035501;s:60:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\public\left_nav.html";i:1494035501;s:60:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\public\head_nav.html";i:1494035501;s:58:"D:\UPUPW\htdocs\zs\1.1.0/app/admin\view\public\footer.html";i:1494035501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_add" method="post" action="<?php echo url('admin/Admin/secondary_vocat_admin_runadd'); ?>">
					...
					<div class="form-group school_group" >
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 负责中职及专业：  </label>
						<div class="col-sm-10">
							<select name="school_id"  class="col-sm-5 " id="school_more" style="width:20%;margin-right:10px;" required>
								<option value="">请选择负责中职</option>
							...
							<select name="major_id[]"  class="col-sm-5 major_more" style="width:20%;" id="major" required>
								<option value="">请选择中职专业</option>
							</select>
							<i class="hanle_school_count fa fa-plus-circle"></i>
							<i class="hanle_school_count fa fa-minus-circle"></i>
						</div>
					</div>
