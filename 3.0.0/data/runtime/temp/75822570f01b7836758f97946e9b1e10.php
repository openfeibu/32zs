<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/member/member_add.html";i:1525856065;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-xs-12">
				<form class="form-horizontal memberform" name="member_list_add" method="post" action="<?php echo url('admin/Member/member_runadd'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="member_list_username" id="member_list_username" placeholder="输入登录身份证号码" class="col-xs-10 col-sm-4" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span class="lbl">&nbsp;&nbsp;不填默认身份证后六位</span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="member_list_nickname" id="member_list_nickname" placeholder="输入姓名" class="col-xs-10 col-sm-4" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填</span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<input name="school_id"  value="<?php echo $admin['school_id']; ?>" type="hidden"/>
					<div class="form-group">
				...
				<!-- 	<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 审核（上传资料审核）： </label>
