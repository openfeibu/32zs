<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:57:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/sys/sys.html";i:1524556078;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<fieldset>
						<div class="tab-content">
							<div id="basic" class="tab-pane fade in active">
								...
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学院名称 </label>
									<div class="col-sm-9">
										<input type="text" name="options[school_name]" id="school_name" value="<?php echo $sys['school_name']; ?>"  class="col-xs-10 col-sm-7" required/>
										<span class="help-inline col-xs-12 col-sm-5">
											<span class="middle" id="restwo">*</span>
										</span>
									</div>
								...
								<div class="space-4"></div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学院首页大图 </label>
									<div class="col-sm-9">
										<input type="hidden" name="checkpic_schoolimg" id="checkpic_schoolimg" value="<?php echo $sys['schoolimg']; ?>" />
										<input type="hidden" name="oldcheckpic_schoolimg" id="oldcheckpic_schoolimg" value="<?php echo $sys['schoolimg']; ?>" />
										<input type="hidden" name="oldcheckpicname_schoolimg" value="<?php echo $sys['schoolimg']; ?>" />
										<a href="javascript:;" class="file" title="点击选择所要上传的图片">
											<input type="file" name="schoolimg" id="schoolimg" multiple="multiple"/>
											选择上传文件
										</a>
										&nbsp;&nbsp;<a href="javascript:;" onclick="return backpic3('<?php echo get_imgurl($sys['schoolimg']); ?>','schoolimg');" title="还原修改前的图片" class="file">
										撤销上传
										</a>
										<div><img src="<?php echo get_imgurl($sys['schoolimg']); ?>" height="70" id="img_schoolimg" ></div>
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group" id="pic_list">
									...
									<div class="col-sm-9">
										<input type="hidden" name="checkpic" id="checkpic_site_logo" value="<?php echo $sys['site_logo']; ?>" />
										<input type="hidden" name="oldcheckpic" id="oldcheckpic_site_logo" value="<?php echo $sys['site_logo']; ?>" />
										<input type="hidden" name="oldcheckpicname" value="<?php echo $sys['site_logo']; ?>" />
										<a href="javascript:;" class="file" title="点击选择所要上传的图片">
											<input type="file" name="site_logo" id="site_logo" multiple="multiple"/>
											选择上传文件
										</a>
										&nbsp;&nbsp;<a href="javascript:;" onclick="return backpic3('<?php echo get_imgurl($sys['site_logo']); ?>','site_logo');" title="还原修改前的图片" class="file">
										撤销上传
										</a>
										<div><img src="<?php echo get_imgurl($sys['site_logo']); ?>" height="70" id="img_site_logo" ></div>
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group" >
									...
									<div class="col-sm-9">
										...
										<script type="text/javascript">
											...
											editor.render("form-field-10");
										</script>
										<textarea  name="options[site_copyright]" cols="20" rows="3" class="col-xs-10 col-sm-7 limited1"   id="form-field-10"  ><?php echo $sys['site_copyright']; ?></textarea>
