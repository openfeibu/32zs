<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/score/score_all.html";i:1528709767;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:70:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/score/ajax_score_all.html";i:1524639087;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/score/score_all'); ?>">
				...
				筛选：
					<select name="major_score_status" class="ajax_change">
						...
						<option value="0" <?php if($major_score_status == '0'): ?>selected="selected"<?php endif; ?>>未审核</option>
						<option value="1" <?php if($major_score_status == '1'): ?>selected="selected"<?php endif; ?>>已审核</option>
					</select>
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="score_form" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('admin/Score/score_active'); ?>" >
						<input name="p" id="p" value="<?php echo input('page',input('p')); ?>" type="hidden" />
