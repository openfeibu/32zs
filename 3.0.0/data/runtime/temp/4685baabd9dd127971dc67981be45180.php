<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"/home/vagrant/Code/32zs/2.0.0/public/yfcmf/error.html";i:1524903786;}*/ ?>
<?php
    ...
    if(!function_exists('parse_file')){
        ...
        {
            return '<a class="toggle" title="'."<?php echo $file; ?> line <?php echo $line; ?>".'">'.basename($file)." line <?php echo $line; ?>".'</a>';
        }
    }
    ...
    if(!function_exists('parse_args')){
        function parse_args($args)
        {
            ...
            foreach ($args as $key => $item) {
                ...
                $result[] = is_int($key) ? $value : "'<?php echo $key; ?>' => <?php echo $value; ?>";
            }
...
<body>
	...
	页面自动 <a id="href" href="./">跳转</a> 等待时间： <b id="wait">5</b>
        ...
        <a title="Homepage" href="http://www.feibu.info">飞步科技</a>
        <span>{ Fast & Simple OOP PHP Framework }</span>
    </div>
