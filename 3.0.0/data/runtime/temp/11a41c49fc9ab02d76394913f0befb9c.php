<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"/home/vagrant/Code/32zs/3.0.0/app/home/view/default/index.html";i:1524764467;s:68:"/home/vagrant/Code/32zs/3.0.0/app/home/view/default/public/head.html";i:1524404521;s:72:"/home/vagrant/Code/32zs/3.0.0/app/home/view/default/public/function.html";i:1524556374;s:70:"/home/vagrant/Code/32zs/3.0.0/app/home/view/default/public/config.html";i:1524556343;s:70:"/home/vagrant/Code/32zs/3.0.0/app/home/view/default/public/footer.html";i:1524764463;}*/ ?>
<?php 
/*这里只是一个模板函数库演示*/
function helloworld(){
	echo "hello 三二分段!";
...
'successful case text'=>'以下案例均由飞步科技开发，部分设计灵感及素材来源于网络,如果您不希望贵司的案例显示在这里，请与我们联系。更多的成功案例正在整理中，请大家继续关注。如您有需要,随时可以联系我们……',
'index one'=>'我们的理念',
...
<body>
    <!-- 头部 S -->
    <div class="header" style="background: url(<?php echo get_imgurl($schoolimg); ?>) no-repeat center;">
    ...
    <div class="main w1000">
        ...
        <div class="login">
            ...
            <?php else: ?>
            <div class="login-title">三二分段招生报名登录</div>
        ...
        <div class="banner">
            <ul>
                <?php if(is_array($center_slideshow_imgs) || $center_slideshow_imgs instanceof \think\Collection || $center_slideshow_imgs instanceof \think\Paginator): if( count($center_slideshow_imgs)==0 ) : echo "" ;else: foreach($center_slideshow_imgs as $k=>$voo): ?>
                    <li <?php if($k == 0): ?>class="active"<?php endif; ?>>
                        <a href="javascript:;">
                            <img src="<?php echo get_imgurl($voo); ?>" alt="">
                        </a>
                    </li>
            ...
            <ol>
                <?php if(is_array($center_slideshow_imgs) || $center_slideshow_imgs instanceof \think\Collection || $center_slideshow_imgs instanceof \think\Paginator): if( count($center_slideshow_imgs)==0 ) : echo "" ;else: foreach($center_slideshow_imgs as $k=>$voo): ?>
                    <li <?php if($k == 0): ?>class="active"<?php endif; ?>></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ol>
        </div>
        <!-- 轮播图 -->
        ...
        <div class="fb-portlet">
            ...
            <ul>
              <?php $news=get_news("cid:17;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,20,"null","");if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): if( count($news)==0 ) : echo "" ;else: foreach($news as $k=>$vo): ?>
        ...
        <div class="portlet">
            ...
            <div class="fb-portlet-url">
                ...
                <div class="input-item">
                    <?php $links_3=get_links(3); ?>
                    <label for="">学院速览：</label>
                    <select onchange="mbar(this)" name="select" style="width:145px;height:27px" >
                        <option selected="selected">----请选择----</option>
                        <?php if(is_array($links_3) || $links_3 instanceof \think\Collection || $links_3 instanceof \think\Paginator): if( count($links_3)==0 ) : echo "" ;else: foreach($links_3 as $key=>$vo): ?>
                        <option value="<?php echo $vo['plug_link_url']; ?>"><?php echo $vo['plug_link_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="input-item">
                    <?php $links_4=get_links(4); ?>
                    <label for="">上级机构：</label>
                    <select onchange="mbar(this)" name="select"style="width:145px;height:27px">
                        <option selected="selected">----请选择----</option>
                        <?php if(is_array($links_4) || $links_4 instanceof \think\Collection || $links_4 instanceof \think\Paginator): if( count($links_4)==0 ) : echo "" ;else: foreach($links_4 as $key=>$vo): ?>
                        <option value="<?php echo $vo['plug_link_url']; ?>"><?php echo $vo['plug_link_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
        ...
        <div class="fb-portlet">
            ...
            <ul>
                <?php $policys=get_news("cid:18;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,20,"null","");if(is_array($policys) || $policys instanceof \think\Collection || $policys instanceof \think\Paginator): if( count($policys)==0 ) : echo "" ;else: foreach($policys as $k=>$vo): ?>
                <li><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><p><?php echo $vo['news_title']; ?></p><span><?php echo date("Y-m-d",$vo['news_time']); ?></span></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="fb-portlet" style="margin-left: 15px;">
            ...
            <ul>
              <?php $notics=get_news("cid:16;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,20,"null","");if(is_array($notics) || $notics instanceof \think\Collection || $notics instanceof \think\Paginator): if( count($notics)==0 ) : echo "" ;else: foreach($notics as $k=>$vo): ?>
              <li><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><p><?php echo $vo['news_title']; ?></p><span><?php echo date("Y-m-d",$vo['news_time']); ?></span></a></li>
              <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="fb-seamless">
            ...
            <div class="fb-seamless-con">
                <ul>
                    <?php if(is_array($footer_slideshow_imgs) || $footer_slideshow_imgs instanceof \think\Collection || $footer_slideshow_imgs instanceof \think\Paginator): if( count($footer_slideshow_imgs)==0 ) : echo "" ;else: foreach($footer_slideshow_imgs as $k=>$voo): ?>
                        <li><img src="<?php echo get_imgurl($voo); ?>" alt=""></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        </div>
