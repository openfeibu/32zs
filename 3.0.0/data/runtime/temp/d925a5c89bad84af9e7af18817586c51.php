<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/ajax_recruit_score_list.html";i:1542291532;}*/ ?>
...
<tr>
    ...
    <td><input type="text" name="recruit_major_score" value="<?php echo $v['recruit_major_score']; ?>" class="recruit_score score_input" data-id="<?php echo $v['member_list_id']; ?>" <?php if($v['recruit_major_score_status'] ==1): ?>disabled<?php endif; ?>></td>
