<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/plug/plug_linktype_list.html";i:1524556078;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556374;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1524556374;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524456538;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524501980;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1524107890;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/三二分段/三二分段.css" />
	<!-- 此页相关css -->
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		<div class="row maintop">
			<button type="submit" href="<?php echo url('admin/Plug/plug_linktype_order'); ?>" id="btnorder" class="btn btn-white btn-yellow btn-sm">排序</button>
			<div class="fb-state-search">
				<form class=" ajaxForm2" name="plug_linktype_add" method="post" action="<?php echo url('admin/Plug/plug_linktype_runadd'); ?>">

					<div ><small class="sl-left10">栏目名称：</small>
						<small>
						...
						<small>
							<button class="btn btn-sm btn-fb-blue fb-radio ruleadd">
								添加栏目
							</button>
						</small>
					</div>
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a href="javascript:;" onclick="return openWindow(<?php echo $v['plug_linktype_id']; ?>,'<?php echo $v['plug_linktype_name']; ?>',<?php echo $v['plug_linktype_order']; ?>);" data-toggle="tooltip" title="修改">
												<i class="ace-icon fa fa-edit bigger-130"></i>
											</a>
											<a class=" confirm-rst-url-btn" href="<?php echo url('admin/Plug/plug_linktype_del',array('plug_linktype_id'=>$v['plug_linktype_id'])); ?>" data-toggle="tooltip"  data-info="你确定要删除吗？" title="删除">
...
<script src="__PUBLIC__/三二分段/三二分段.js?<?php echo time(); ?>"></script>
<!-- 此页相关插件js -->
