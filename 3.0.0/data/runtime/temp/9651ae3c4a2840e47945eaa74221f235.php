<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/admin/secondary_vocat_admin_edit.html";i:1524575949;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/secondary_vocat_admin_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<span class="lbl col-xs-12 col-sm-12"><span class="red">*</span>用户名必须是以字母开头，数字、符号组合</span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<span class="lbl col-xs-12 col-sm-12"><span class="red"></span>密码必须大于6位，小于15位</span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<!-- <div class="form-group">
						...
						<div class="col-sm-6">
							...
							<span class="lbl col-xs-12 col-sm-12"><span class="red">*</span>用于密码找回，请认真填写</span>
						</div>
					</div>
					<div class="space-4"></div> -->


					<div class="form-group school_group" id='school_html'>
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 所属中职: </label>
						<div class="col-sm-6">
							<select name="school_id"  class="col-sm-5"  id="school_more"  style="width:350px;margin-right:10px;" required>
					...
					<div class="form-group school_group">
						...
						<div id="major-box">
							<div class="checkbox">
								...
								<label id="news_flag_h">
									<input <?php if(in_array($v['major_id'],$major_ids)): ?>checked<?php endif; ?> class="ace ace-checkbox-2" type="checkbox" name="major_id[]" value="<?php echo $v['major_id']; ?>">
										<span class="lbl"><?php echo $v['major_name']; ?></span>
								</label>
								<?php endforeach; endif; else: echo "" ;endif; ?>
