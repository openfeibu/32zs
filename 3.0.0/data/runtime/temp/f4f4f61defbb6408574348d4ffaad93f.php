<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/enrollment/enrollment.html";i:1541575817;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row maintop">
			...
			<div class="fb-export">
				<a href="<?php echo url('admin/Enrollment/export_enrollment'); ?>">导出招生计划</a>
			</div>
						...
						<tbody id="ajax-data">
							<?php if(!empty($enrollments)): if(is_array($enrollments) || $enrollments instanceof \think\Collection || $enrollments instanceof \think\Paginator): if( count($enrollments)==0 ) : echo "" ;else: foreach($enrollments as $key=>$v): ?>
								<tr>
									...
									<td><?php echo $v['enrollment_id']; ?></td>
									...
									<td>
										<?php echo $v['major_desc']; ?>
									</td>
									<td><?php echo $v['enrollment_number']; ?></td>
									<td>
							            <div class=" action-buttons">
							                <a href="<?php echo url('admin/Enrollment/enrollment_edit',array('enrollment_id'=>$v['enrollment_id'])); ?>" title="修改">
							                    <i class="ace-icon fa fa-edit bigger-130"></i>																</a>
							                    <a class=" confirm-rst-url-btn" data-info="确定要删除吗？" href="<?php echo url('admin/Enrollment/enrollment_del',array('enrollment_id'=>$v['enrollment_id'])); ?>" title="删除">
