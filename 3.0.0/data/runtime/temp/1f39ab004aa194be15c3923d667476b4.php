<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:76:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/universityscore/score_list.html";i:1542215617;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:81:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/universityScore/ajax_score_list.html";i:1542204467;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- <tr><td colspan="20"><div class="fb-page"><?php echo $page; ?></div></td></tr> -->
	...
	<script type="text/javascript">
		...
		$("#score_list_export").click(function(){
			...
			load = layer.load(1);
			$.ajax({
			    url:"<?php echo url('admin/Score/check_score_list_export'); ?>",
				type:"POST",
				data:{'major_id':major_id},
				success: function(data){
					if(typeof load!="undefined"){layer.close(load);}
					if (data.code == 1) {
				        window.location.href="<?php echo url('admin/Score/score_list_export'); ?>?major_id="+major_id;
				    } else {
