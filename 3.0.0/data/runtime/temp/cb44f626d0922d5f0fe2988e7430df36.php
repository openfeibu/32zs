<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\school\major_edit.html";i:1493037782;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1493050510;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1492917079;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1492917366;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1492917366;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="page-header">
			<h1>
				...
				<small>
					...
					修改中职（<?php echo $school['school_name']; ?>）专业 <?php echo $major['major_name']; ?>
				</small>
			</h1>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/School/major_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="number" value="<?php echo $major['number']; ?>" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 可报考专业： </label>
						<div class="col-sm-10">
							<select name="recruit_major_id" class="col-sm-4 selector" required>
								<option value="">请选择可报考专业</option>
								<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
									<option value='<?php echo $v['recruit_major_id']; ?>' <?php if($v['recruit_major_id'] == $major['recruit_major_id']): ?>selected<?php endif; ?>><?php echo $v['recruit_major_name']; ?></option>
					...
					<div class="form-group major_score_group">
						...
						<div class="col-sm-10">
							<input type="text" name="score[]" value="<?php echo $v; ?>" />
						</div>
					</div>
					<div class="space-4"></div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
