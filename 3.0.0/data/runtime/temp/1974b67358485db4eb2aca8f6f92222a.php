<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/score_add.html";i:1542204392;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
	...
	<div class="row">
	    <div class="col-xs-12">
			...
			<?php if($major_subject_score_arr): if(is_array($major_subject_score_arr) || $major_subject_score_arr instanceof \think\Collection || $major_subject_score_arr instanceof \think\Paginator): if( count($major_subject_score_arr)==0 ) : echo "" ;else: foreach($major_subject_score_arr as $k=>$v): ?>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo $v['subject_name']; ?>: </label>
				<div class="col-sm-10">
					<input type="text" name="score[]" value="<?php echo $v['score']; ?>" class="col-xs-10 col-sm-4" required/>
					<input type="hidden" name="subject_id[]" value="<?php echo $v['subject_id']; ?>" class="col-xs-10 col-sm-4" />
				</div>
			</div>
