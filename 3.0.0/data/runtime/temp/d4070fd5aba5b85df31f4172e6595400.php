<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/subject/subject_edit.html";i:1542344860;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="page-header">
			<span><?php echo $school['school_name']; ?> <?php echo $major['major_name']; ?> 基础理论科目编辑</span>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="major_list_add" method="post" action="<?php echo url('admin/Subject/subject_runedit'); ?>">
					<input type="hidden" name='major_id' value="<?php echo $major['major_id']; ?>">
					<?php if($major['major_subject_name_arr']): if(is_array($major['subjects']) || $major['subjects'] instanceof \think\Collection || $major['subjects'] instanceof \think\Paginator): if( count($major['subjects'])==0 ) : echo "" ;else: foreach($major['subjects'] as $k=>$v): ?>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 科目<?php echo $k+1; ?>： </label>
						<div class="col-sm-10">
							<input type="text" name="subject_name[]" value="<?php echo $v['subject_name']; ?>" />
							<input type="text" name="max_score[]" value="<?php echo $v['max_score']; ?>" style="width: 100px;"/>
							<input type="hidden" name="subject_id[]" value="<?php echo $v['subject_id']; ?>" />
							<i class="fa-2x fa fa-close red delete-subject" attr-id="<?php echo $v['subject_id']; ?>"></i>
						</div>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; else: ?>
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							<input type="hidden" name="year" value="<?php echo $enrollment['year']; ?>">
