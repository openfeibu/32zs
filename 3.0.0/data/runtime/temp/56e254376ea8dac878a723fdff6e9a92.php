<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:85:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/university_score/major_score_import.html";i:1542275063;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:90:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/university_score/ajax_major_score_import.html";i:1542275118;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal ajaxScoreForm" name="excel_runimport" method="post" action="<?php echo url('admin/UniversityScore/major_score_runimport'); ?>"  enctype="multipart/form-data">
            ...
            <div class="row">
    			<div class="col-xs-12">
    				<div>
    					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('admin/UniversityScore/major_score_export_runimport'); ?>" >
...
$(function(){
    $(function () {
		...
		$("#downexcel").click(function(){
			...
			load = layer.load(1);
			$.ajax({
			    url:"<?php echo url('admin/UniversityScore/check_major_score_import'); ?>",
				type:"POST",
				data:{'major_id':major_id,'school_id':school_id},
				success: function(data){
					if(typeof load!="undefined"){layer.close(load);}
					if (data.code == 1) {
				        window.location.href = "<?php echo url('admin/UniversityScore/major_score_export_forimport'); ?>?major_id="+major_id+"&school_id="+school_id;
				    } else {
				        layer.alert(data.msg, {icon: 5});
						return false;
				    }
