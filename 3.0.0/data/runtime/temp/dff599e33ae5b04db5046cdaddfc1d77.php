<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/member/university_member_edit.html";i:1542355953;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content ">
			...
			<div class="col-xs-12">
				<form class="form-horizontal memberform" name="member_list_edit" method="post" action="">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="member_list_username" id="member_list_username" value="<?php echo $member_list_edit['member_list_username']; ?>" placeholder="输入登录用户名" class="col-xs-10 col-sm-4" disabled/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="member_list_nickname" id="member_list_nickname" value="<?php echo $member_list_edit['member_list_nickname']; ?>"  placeholder="输入姓名" class="col-xs-10 col-sm-4" disabled/>
						</div>
					</div>
					<div class="space-4"></div>
        ...
        <div class="clearfix form-actions printHide">
            <div class="col-md-offset-3 col-md-9"  href="<?php echo url('admin/Member/member_active'); ?>" data-id="<?php echo $member_list_edit['member_list_id']; ?>">
                ...
                <?php endif; if(isset($last_member_list_id)): ?>
