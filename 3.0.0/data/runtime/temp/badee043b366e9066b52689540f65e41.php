<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/school/school_edit.html";i:1524456538;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1524573428;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524456538;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524501980;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1524107890;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-buttons navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				...
				<?php endif; ?>
				<li class="logOut">
					<a class="confirm-btn fb-transition" href="<?php echo url('admin/Login/logout'); ?>"  data-info="你确定要退出系统吗？" >
						退出系统
					</a>
				</li>
				<!-- 用户菜单开始 -->
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/School/school_runedit'); ?>">
					<input type="hidden" name="school_id" value="<?php echo $school['school_id']; ?>"/>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 学院名称： </label>
						<div class="col-sm-10">
							<input type="text" name="school_name" value="<?php echo $school['school_name']; ?>" />
						</div>
					</div>
