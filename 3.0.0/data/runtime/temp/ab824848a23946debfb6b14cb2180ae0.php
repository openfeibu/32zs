<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:74:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/recruit_score_list.html";i:1542291948;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:79:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/ajax_recruit_score_list.html";i:1542293620;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/score/recruit_score_list'); ?>">
				<div class="fb-state-search  margintop5">
					...
					<select name="recruit_major_score_status" class="ajax_change" id="recruit_major_score_status">
						...
						<option value="0" <?php if($recruit_major_score_status == '0'): ?>selected="selected"<?php endif; ?>>未审核</option>
						<option value="1" <?php if($recruit_major_score_status == '1'): ?>selected="selected"<?php endif; ?>>已审核</option>
					</select>
					中职学校：
...
<tr>
    <td class="hidden-xs" height="28" >
        <label class="pos-rel">
            <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['member_list_id']; ?>" <?php if($v['recruit_major_score_status'] == 1): ?>disabled<?php endif; ?>>
            <span class="lbl"></span>
        </label>
    </td>
    ...
    <td><input type="text" name="recruit_major_score" value="<?php echo $v['recruit_major_score']; ?>" class="recruit_major_score score_input" data-id="<?php echo $v['member_list_id']; ?>" <?php if($v['recruit_major_score_status'] ==1): ?>disabled<?php endif; ?>></td>
...
<script>
	...
	$("#recruit_score_list_export").click(function(){
		...
		load = layer.load(1);
		$.ajax({
			url:"<?php echo url('admin/Score/check_recruit_score_list_export'); ?>",
			type:"POST",
			data:{'school_id':school_id},
			success: function(data){
				if(typeof load!="undefined"){layer.close(load);}
				if (data.code == 1) {
					window.location.href="<?php echo url('admin/Score/recruit_score_list_export'); ?>?school_id="+school_id
				} else {
