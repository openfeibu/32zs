<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/school/recruit_major_list.html";i:1526375277;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="fb-add">
				<a href="<?php echo url('admin/School/recruit_major_add'); ?>" class="fb-transition">
						添加高职专业
				</a>
			</div>
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($major_list) || $major_list instanceof \think\Collection || $major_list instanceof \think\Paginator): if( count($major_list)==0 ) : echo "" ;else: foreach($major_list as $key=>$v): ?>
								<tr>
							        ...
							        <td><?php echo $v['recruit_major_id']; ?></td>
									...
									<td>
										<?php if(is_array($v['enrollment_school_mumber_count_arr']) || $v['enrollment_school_mumber_count_arr'] instanceof \think\Collection || $v['enrollment_school_mumber_count_arr'] instanceof \think\Paginator): if( count($v['enrollment_school_mumber_count_arr'])==0 ) : echo "" ;else: foreach($v['enrollment_school_mumber_count_arr'] as $key=>$sv): ?>
											<?php echo $sv['school_name']; ?> : <?php echo $sv['member_count']; ?><br/>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</td>
									<!-- <td><?php echo $v['min_score']; ?></td> -->
									<td>
										<div class="action-buttons">
											<a  href="<?php echo url('admin/School/recruit_major_edit',array('recruit_major_id'=>$v['recruit_major_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-edit bigger-130"></i>																</a>
												<a class="confirm-rst-url-btn" data-info="确定要删除吗？" href="<?php echo url('admin/School/recruit_major_del',array('recruit_major_id'=>$v['recruit_major_id'])); ?>" title="删除">
