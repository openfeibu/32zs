<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:64:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/news/news_list.html";i:1525061379;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1525856357;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:69:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/news/ajax_news_list.html";i:1524730208;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
 ...
 -->
	...
	<div class="page-content">
		...
		<button  id="btnorder" href="<?php echo url('admin/News/news_order'); ?>" class="btn btn-white btn-yellow btn-sm">更新排序</button>
		<button id="btnsubmit" class="btn btn-white btn-yellow btn-sm hidden-xs">批量删除</button>
		<form name="admin_list_sea" class="form-search " id="list-filter" method="post" action="<?php echo url('admin/News/news_list'); ?>">
	...
	<tr>
		...
		<!-- <td class="hidden-xs">
			<?php if($v['news_open'] == 1): ?>
				<a class="red state-btn" href="<?php echo url('admin/News/news_state'); ?>" data-id="<?php echo $v['n_id']; ?>" title="已审">
					<div><button class="btn btn-minier btn-fb-blue">已审</button></div>
				</a>
				<?php else: ?>
				<a class="red state-btn" href="<?php echo url('admin/News/news_state'); ?>" data-id="<?php echo $v['n_id']; ?>" title="未审">
					<div><button class="btn btn-minier btn-fb-orange">未审</button></div>
				</a>
			<?php endif; ?>
		</td> -->
		...
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a href="<?php echo url('admin/News/news_edit',array('n_id'=>$v['n_id'])); ?>" data-toggle="tooltip" title="修改">
					<i class="ace-icon fa fa-edit bigger-130"></i>
				</a>
				<a class=" confirm-rst-url-btn" data-info="确定要删除到回收站吗？" href="<?php echo url('admin/News/news_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="回收站" data-toggle="tooltip">
