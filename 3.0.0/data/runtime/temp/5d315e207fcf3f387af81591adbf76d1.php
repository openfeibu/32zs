<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:84:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/sec_vocat_recruit_score_list.html";i:1542293934;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:89:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/ajax_sec_vocat_recruit_score_list.html";i:1542293921;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		<div class="row maintop">
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/score/sec_vocat_recruit_score_list'); ?>">
				<div class="fb-state-search  margintop5">
					请选择高职专业：
					<select name="recruit_major_id" class="ajax_change" id="recruit_major_id">
						<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
							<option value="<?php echo $v['recruit_major_id']; ?>" <?php if($recruit_major['recruit_major_id'] == $v['recruit_major_id']): ?>selected="selected"<?php endif; ?>><?php echo $v['recruit_major_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
					<div class="fb-export" style="float: none;display: inline-block;">
						<a href="javascript:;" onclick="javascript:var recruit_major_id = $('#recruit_major_id').val();window.location.href='<?php echo url('admin/Score/school_recruit_score_export'); ?>?score=0&recruit_major_id='+recruit_major_id" title="导出技能考核登分表">导出技能考核登分表</a>
					</div>
					<div class="fb-export" style="float: none;display: inline-block;">
						<a href="javascript:;" onclick="javascript:var recruit_major_id = $('#recruit_major_id').val();window.location.href='<?php echo url('admin/Score/school_recruit_score_export'); ?>?score=1&recruit_major_id='+recruit_major_id" title="导出技能考核成绩单">导出技能考核成绩单</a>
					</div>
				</div>
			</form>
		</div>
...
<tr>
    ...
    <td><?php echo $v['recruit_major_score']; ?></td>
