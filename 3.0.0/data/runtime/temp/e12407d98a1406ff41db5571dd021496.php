<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/enrollment/enrollment_edit.html";i:1524456538;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1524576928;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524456538;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524501980;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1524107890;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
						...
						<div class="col-sm-10">
							<select name="school_id" class="col-sm-4 selector"  style='width:20%;margin-right:10px;' required disabled>
								...
								<?php if(is_array($school_list) || $school_list instanceof \think\Collection || $school_list instanceof \think\Paginator): if( count($school_list)==0 ) : echo "" ;else: foreach($school_list as $key=>$v): ?>
									<option value='<?php echo $v['school_id']; ?>' <?php if($v['school_id'] == $enrollment['school_id']): ?>selected<?php endif; ?> ><?php echo $v['school_name']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>

							</select>
							<?php if(is_array($enrollment['major_id_arr']) || $enrollment['major_id_arr'] instanceof \think\Collection || $enrollment['major_id_arr'] instanceof \think\Paginator): if( count($enrollment['major_id_arr'])==0 ) : echo "" ;else: foreach($enrollment['major_id_arr'] as $key=>$val): ?>
							<select name="major_id[]"  class="col-sm-5 major_more" style="width:20%;margin-right:10px;"  required disabled>
								...
								<?php if(is_array($major_list) || $major_list instanceof \think\Collection || $major_list instanceof \think\Paginator): if( count($major_list)==0 ) : echo "" ;else: foreach($major_list as $k=>$v): ?>
-+
								<?php if($key == 1 || (isset($last_val) && $last_val != $v['major_id'])): ?>
								<option value="<?php echo $v['major_id']; ?>" <?php if($v['major_id'] == $val): ?>selected<?php endif; ?>><?php echo $v['major_name']; ?></option>
