<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:77:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/university_score/score_list.html";i:1542248586;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:82:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/university_score/ajax_score_list.html";i:1542293762;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		<div class="row maintop">
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/universityScore/score_list'); ?>">
				<div class="fb-state-search  margintop5">
					审核状态：
					<select name="major_score_status" class="ajax_change">
						<option value="">所有</option>
						<option value="0" <?php if($major_score_status == '0'): ?>selected<?php endif; ?>>未审核</option>
						<option value="1" <?php if($major_score_status == '1'): ?>selected<?php endif; ?>>已审核</option>
					</select>
					中职学校：
					...
					<select name="major_id" class="ajax_change" id="major">
						...
						<option value="<?php echo $v['major_id']; ?>" <?php if($major_id == $v['major_id']): ?>selected<?php endif; ?>><?php echo $v['major_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('admin/universityScore/score_active'); ?>" >
...
<tr>
    <td height="28" >
        <label class="pos-rel">
            <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['member_list_id']; ?>" <?php if($v['major_score_status'] ==1): ?>disabled<?php endif; ?>>
            <span class="lbl"></span>
        </label>
    </td>
...
<!-- <tr><td colspan="20"><div class="fb-page"><?php echo $page; ?></div></td></tr> -->
	...
	<script type="text/javascript">
		...
		$("#score_list_export").click(function(){
			...
			load = layer.load(1);
			$.ajax({
			    url:"<?php echo url('admin/UniversityScore/check_score_list_export'); ?>",
				type:"POST",
				data:{'major_id':major_id,'school_id':school_id},
				success: function(data){
					if(typeof load!="undefined"){layer.close(load);}
					if (data.code == 1) {
				        window.location.href="<?php echo url('admin/UniversityScore/score_list_export'); ?>?major_id="+major_id+"&school_id="+school_id;
				    } else {
