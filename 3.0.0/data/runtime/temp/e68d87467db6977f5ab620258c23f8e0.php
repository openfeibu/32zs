<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/invoice/show.html";i:1527212556;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
 ...
 -->
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/Invoice/create'); ?>">
					<input type="hidden" name="invoice_id" value=""/>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1" style="font-size:16px;"> <?php echo \think\Lang::get('invoice')['title']; ?></label>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['name']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="name" placeholder="必填" value="<?php echo (isset($invoice['name']) && ($invoice['name'] !== '')?$invoice['name']:''); ?>" required/>
							<span class="lbl"><span class="red">*</span>必填</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['duty_paragraph']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="duty_paragraph" placeholder="必填" value="<?php echo (isset($invoice['duty_paragraph']) && ($invoice['duty_paragraph'] !== '')?$invoice['duty_paragraph']:''); ?>" required/>
							<span class="lbl"><span class="red">*</span>必填</span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['address']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="address" value="<?php echo (isset($invoice['address']) && ($invoice['address'] !== '')?$invoice['address']:''); ?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['tel']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="tel" value="<?php echo (isset($invoice['tel']) && ($invoice['tel'] !== '')?$invoice['tel']:''); ?>" regex="0\d{2,3}-?\d{7,8}" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['bank']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="bank" value="<?php echo (isset($invoice['bank']) && ($invoice['bank'] !== '')?$invoice['bank']:''); ?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['blank_count']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="blank_count" value="<?php echo (isset($invoice['blank_count']) && ($invoice['blank_count'] !== '')?$invoice['blank_count']:''); ?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo \think\Lang::get('invoice')['secondary']['other']; ?>： </label>
						<div class="col-sm-4">
							<input type="text" name="other" value="<?php echo (isset($invoice['other']) && ($invoice['other'] !== '')?$invoice['other']:''); ?>"/>
						</div>
					</div>
