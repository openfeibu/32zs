<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/index/index.html";i:1542299455;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
 ...
 -->
	...
	<div class="mainPcontent">
		<?php if($admin['group_id'] == 3): ?>
		<div class="zz-infobox">
			...
			<div class="zz-infobox-item">
				<div class="zz-infobox-item-title"><?php echo $val['major_name']; ?></div>
				<div class="zz-infobox-item-count">考生人数：<?php echo $val['student_count']; ?></div>

				<ul class="zz-infobox-item-list">
					<li>
						<span>报名已审核</span>
						<p><?php echo $val['enrolment_auditing_count']; ?></p>
					</li>
					<li>
						<span>报名未审核</span>
						<p><?php echo $val['enrolment_unauditing_count']; ?></p>
					</li>
					<li>
						<span>基础理论成绩已审核</span>
						<p><?php echo $val['score_auditing_count']; ?></p>
					</li>
					<li>
						<span>基础理论成绩未审核</span>
						<p><?php echo $val['score_unauditing_count']; ?></p>
					</li>
				</ul>
			</div>
		...
		<?php endif; if($admin['group_id'] == 4): ?>
				<div class="infobox-box">
						<div style="height:100%;">
							<div class="infobox-data">

								<div class="infobox-content info-box  info-box-green"><span>考生人数</span><p><?php echo $statistics['student_count']; ?></p></div>
								<div class="infobox-content info-box  info-box-yellow"><span>基础理论成绩已审核</span><p><?php echo $statistics['score_auditing_count']; ?></p></div>
								<div class="infobox-content info-box info-box-blue"><span>基础理论成绩未审核</span><p><?php echo $statistics['score_unauditing_count']; ?></p></div>
							</div>
							<div class="infobox-data">
								<div class="infobox-content info-box  info-box-yellow"><span>技能考核成绩已审核</span><p><?php echo $statistics['recruit_major_score_auditing_count']; ?></p></div>
								<div class="infobox-content info-box info-box-blue"><span>技能考核成绩未审核</span><p><?php echo $statistics['recruit_major_score_unauditing_count']; ?></p></div>
							</div>
						</div>
					</div>


		<?php endif; if($admin['group_id'] == 1 || $admin['group_id'] == 5): ?>
					<div class="infobox-box">
						<div style="height:100%;">
							<div class="infobox-data">
								<div class="infobox-content info-box  info-box-blue"><span>高职专业</span><p><?php echo $statistics['recruit_major_count']; ?></p></div>
								<div class="infobox-content info-box  info-box-green"><span>中职学校</span><p><?php echo $statistics['school_count']; ?></p></div>
								<div class="infobox-content info-box  info-box-yellow"><span>中职专业</span><p><?php echo $statistics['major_count']; ?></p></div>
								<div class="infobox-content info-box info-box-blue"><span>技能考核分数线</span><p><?php echo $statistics['min_score']; ?></p></div>
								<div class="infobox-content info-box info-box-green"><span>招生计划数</span><p><?php echo (isset($statistics['enroll_count']) && ($statistics['enroll_count'] !== '')?$statistics['enroll_count']:0); ?></p></div>
								<div class="infobox-content info-box info-box-yellow"><span>已报名人数</span><p><?php echo (isset($statistics['student_count']) && ($statistics['student_count'] !== '')?$statistics['student_count']:0); ?></p></div>
								<div class="infobox-content info-box info-box-blue"><span>已录取人数</span><p><?php echo $statistics['enroll_student_count']; ?></p></div>
							</div>
						</div>
					</div>
		<?php if($admin['group_id'] == 1): ?>
		<?php echo hook('maintain'); endif; endif; ?>
	</div>
