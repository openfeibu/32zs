<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:74:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/major_score_import.html";i:1527091187;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:79:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/score/ajax_major_score_import.html";i:1542275047;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal ajaxScoreForm" name="excel_runimport" method="post" action="<?php echo url('admin/Score/major_score_import'); ?>"  enctype="multipart/form-data">
					<div style="margin-bottom:10px;">
						<div style="float:left;margin-right:10px">
		                    <p>注意事项：</p>
							<p>1、确保系统内已有考生基础数据，已设好科目，才能导入。</p>
							<p>2、导出的模板表格中仅含未审核成绩的考生及其科目信息。</p>
							<p>3、在模板上登记成绩时，仅填分数即可，勿修改其他信息。</p>
							<p>操作流程：</p>
					...
					<div class="fb-export"><a href="javascript:;" id="downexcel">下载对应专业基础成绩录入模板</a></div>
            ...
            <div class="row">
    			<div class="col-xs-12">
    				<div>
    					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('admin/Score/major_score_export_runimport'); ?>" >
...
<tr>
    ...
    <td data-id="<?php echo $v['member_list_id']; ?>"><input name="major_score_<?php echo $v['member_list_id']; ?>[]" value="<?php echo $val; ?>" class="score_input"> </td>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </td>
</tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
$(function(){
    $(function () {
		...
		$("#downexcel").click(function(){
			...
			load = layer.load(1);
			//var url= "<?php echo url('admin/Score/major_score_export_forimport'); ?>";
			$.ajax({
			    url:"<?php echo url('admin/Score/check_major_score_import'); ?>",
				type:"POST",
				data:{'major_id':major_id},
				success: function(data){
					if(typeof load!="undefined"){layer.close(load);}
					if (data.code == 1) {
				        window.location.href = "<?php echo url('admin/Score/major_score_export_forimport'); ?>?major_id="+major_id;
				    } else {
				        layer.alert(data.msg, {icon: 5});
						return false;
				    }
