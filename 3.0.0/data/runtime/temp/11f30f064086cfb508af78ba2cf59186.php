<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/home/vagrant/Code/32zs/2.0.0/app/home/view/default/user/center.html";i:1524763615;s:75:"/home/vagrant/Code/32zs/2.0.0/app/home/view/default/public/head_center.html";i:1524107926;s:70:"/home/vagrant/Code/32zs/2.0.0/app/home/view/default/public/footer.html";i:1524764463;}*/ ?>
    ...
    <div class="main w1000" style="background:#fff;">
        ...
        <div class="personal_table">
                <table width="656px">
                    ...
                    <tr><td colspan="3" style="text-align: center;font-size: 25px;font-weight: bold;border-top:1px solid #000000;line-height:48px;"><?php echo date('Y'); ?>年三二分段报名表</td></tr>

                </tbody></table>
                <br>
                <table width="656px" class="k-w-table line_table subform">
                    <tbody><tr class="line-table-height">
                        ...
                        <td class="k-s-content low_width_7" rowspan="5" style="text-align: center;position:relative">
                                ...
                                <img  style="width: 125px; height: 175px; display: inline;" src="<?php if($user['member_list_headpic']): ?><?php echo get_imgurl($user['member_list_headpic'],1); else: ?><?php echo $yf_theme_path; ?>public/images/defaultGraph.jpg<?php endif; ?> " height="175px" width="125px"  class="headicon" <?php if($user['user_status'] != 1): ?>data-toggle="modal" data-target="#myModal"  title="建议使用ie9以上浏览器，360浏览器建议使用极速模式"<?php endif; ?>>
                    ...
                    <tr class="line-table-height">
                        ...
                        <td class="k-s-content title" colspan="3">在何地、何单位学习或工作</td>
                        <td class="k-s-content title" colspan="2">任何职务</td>

                    </tr>
                    <tr class="line-table-height">
                        <td class="k-s-content title" colspan="1"><input type="text" name="resumeBeforeDate_0" value="<?php echo $info['resume']['0']['resumeBeforeDate']; ?>" class="noBlur" id="resumeBeforeDate_0"/></td>
                        <td class="k-s-content title" colspan="1"><input type="text" name="resumeAfterDate_0" value="<?php echo $info['resume']['0']['resumeAfterDate']; ?>" class="noBlur" id="resumeAfterDate_0"/></td>
                        <td class="k-s-content title" colspan="3"><input type="text" name="resumeWork_0" value="<?php echo $info['resume']['0']['resumeWork']; ?>"/></td>
                        <td class="k-s-content title" colspan="2"><input type="text" name="resumePost_0" value="<?php echo $info['resume']['0']['resumePost']; ?>"/></td>

                    </tr>
                    <tr class="line-table-height">
                         <td class="k-s-content title" colspan="1"><input type="text" name="resumeBeforeDate_1" value="<?php echo $info['resume']['1']['resumeBeforeDate']; ?>" class="noBlur" id="resumeBeforeDate_1"/></td>
                        <td class="k-s-content title" colspan="1"><input type="text" name="resumeAfterDate_1" value="<?php echo $info['resume']['1']['resumeAfterDate']; ?>" class="noBlur" id="resumeAfterDate_1"/></td>
                        <td class="k-s-content title" colspan="3"><input type="text" name="resumeWork_1" value="<?php echo $info['resume']['1']['resumeWork']; ?>"/></td>
                        <td class="k-s-content title" colspan="2"><input type="text" name="resumePost_1" value="<?php echo $info['resume']['1']['resumePost']; ?>"/></td>

                    </tr>
                    <tr class="line-table-height">
                          <td class="k-s-content title" colspan="1"><input type="text" name="resumeBeforeDate_2" value="<?php echo $info['resume']['2']['resumeBeforeDate']; ?>" class="noBlur" id="resumeBeforeDate_2"/></td>
                        <td class="k-s-content title" colspan="1"><input type="text" name="resumeAfterDate_2" value="<?php echo $info['resume']['2']['resumeAfterDate']; ?>" class="noBlur" id="resumeAfterDate_2"/></td>
                        <td class="k-s-content title" colspan="3"><input type="text" name="resumeWork_2" value="<?php echo $info['resume']['2']['resumeWork']; ?>"/></td>
                        <td class="k-s-content title" colspan="2"><input type="text" name="resumePost_2" value="<?php echo $info['resume']['2']['resumePost']; ?>"/></td>
...
<?php if($user['user_status'] == 1): endif; ?>
</script>
<?php if($user['user_status'] == 1): ?>
<script>
$(".subform").find("input").attr('disabled',true);
$(".subform").find("select").attr('disabled',true);
$(".subform").find("textarea").attr('disabled',true);
</script>
<?php endif; ?>
