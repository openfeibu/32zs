<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/examination/createexamination.html";i:1527077286;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
			...
			<div class="col-xs-12">
				<div>
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tbody >
                                <?php if(is_array($recruit_major_data) || $recruit_major_data instanceof \think\Collection || $recruit_major_data instanceof \think\Paginator): if( count($recruit_major_data)==0 ) : echo "" ;else: foreach($recruit_major_data as $key=>$v): ?>
                                <tr>
                                    <td height="28" >
                                        <input type="hidden" name="recruit_major_id" value="<?php echo $v['recruit_major_id']; ?>">
                                    </td>
									<td><?php echo $v['recruit_major_name']; ?></td>
                                    <td>
                                        <?php if(is_array($v['majors']) || $v['majors'] instanceof \think\Collection || $v['majors'] instanceof \think\Paginator): if( count($v['majors'])==0 ) : echo "" ;else: foreach($v['majors'] as $key=>$major): ?>
                                            <?php echo $major['major_name']; endforeach; endif; else: echo "" ;endif; ?>
                                    </td>
                                    <td class="member_count" data-value="<?php echo $v['member_count']; ?>"><?php echo $v['member_count']; ?></td>
                                    <td width="400px">
                                        <?php if(is_array($rooms) || $rooms instanceof \think\Collection || $rooms instanceof \think\Paginator): if( count($rooms)==0 ) : echo "" ;else: foreach($rooms as $key=>$rv): ?>
                                        <label>
                                            <input type="checkbox" name="room_id" value="<?php echo $rv['room_id']; ?>" class="room_id" attr-value="<?php echo $rv['room_number']; ?>" <?php if(in_array($rv['room_id'],$v['room_id'])): ?>checked<?php endif; ?>/><?php echo $rv['room_name']; ?>(<?php echo $rv['room_number']; ?>人)
                                        </label>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </td>
                                    <td>
                                        <input type="text" class="layui-input date" id="date_<?php echo $v['recruit_major_id']; ?>" name="date" style="width:100px;" value="<?php echo (isset($v['examination']['date']) && ($v['examination']['date'] !== '')?$v['examination']['date']:date('Y-m-d')); ?>">
                                    </td>
                                    <td>
                                        <input type="text" class="layui-input starttime" id="starttime_<?php echo $v['recruit_major_id']; ?>" name="starttime" style="width:80px;margin-right:5px;" value="<?php echo (isset($v['examination']['starttime']) && ($v['examination']['starttime'] !== '')?$v['examination']['starttime']:'00:00'); ?>">
                                        <input type="text" class="layui-input endtime" id="endtime_<?php echo $v['recruit_major_id']; ?>" name="starttime" style="width:80px;" value="<?php echo (isset($v['examination']['endtime']) && ($v['examination']['endtime'] !== '')?$v['examination']['endtime']:'00:00'); ?>"></td>
                                    <td>
                            			<div class="hidden-sm hidden-xs action-buttons">
                            				<button class="btn btn-fb-blue fb-radio examination-btn examination-submit" <?php if($v['is_examination'] == 1): else: ?>disabled<?php endif; ?>>保存</button>
                                            <button class="btn btn-fb-blue fb-radio examination-btn examination-submit download" <?php if($v['is_examination'] == 1): else: ?>disabled<?php endif; ?> style="width:100px" href='<?php echo url('admin/Examination/exportExamination',['recruit_major_id' => $v['recruit_major_id']]); ?>'>导出准考证</button>
                                            <button class="btn btn-fb-blue fb-radio examination-btn examination-submit download" <?php if($v['is_examination'] == 1): else: ?>disabled<?php endif; ?> style="width:100px" href='<?php echo url('admin/Examination/exportExaminationSeats',['recruit_major_id' => $v['recruit_major_id']]); ?>'>导出座位贴</button>
                            			</div>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <script>
        $(function(){
            <?php if(is_array($recruit_major_data) || $recruit_major_data instanceof \think\Collection || $recruit_major_data instanceof \think\Paginator): if( count($recruit_major_data)==0 ) : echo "" ;else: foreach($recruit_major_data as $key=>$v): ?>
            laydate.render({
              elem: '#date_<?php echo $v['recruit_major_id']; ?>'
            });
            laydate.render({
              elem: '#starttime_<?php echo $v['recruit_major_id']; ?>'
              ,type: 'time'
              ,format: 'HH:mm'
            });
            laydate.render({
              elem: '#endtime_<?php echo $v['recruit_major_id']; ?>'
              ,type: 'time'
              ,format: 'HH:mm'
            });
            <?php endforeach; endif; else: echo "" ;endif; ?>
