<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/invoice/index.html";i:1527232889;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
				...
				<div>
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tr>
								<th width="60px"></th>
								<!-- <th>中职学校</th> -->
								<th><?php echo \think\Lang::get('invoice')['high_school']['name']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['duty_paragraph']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['address']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['tel']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['bank']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['blank_count']; ?></th>
								<th><?php echo \think\Lang::get('invoice')['high_school']['other']; ?></th>
							</tr>
							</thead>

							<tbody>
							<?php if(is_array($invoice_list) || $invoice_list instanceof \think\Collection || $invoice_list instanceof \think\Paginator): if( count($invoice_list)==0 ) : echo "" ;else: foreach($invoice_list as $key=>$v): ?>
								<tr>
									<td height="28"></td>
									<!-- <td><?php echo $v['school_name']; ?></td> -->
									<td><?php echo $v['name']; ?></td>
									<td><?php echo $v['duty_paragraph']; ?></td>
									<td><?php echo $v['address']; ?></td>
									<td><?php echo $v['tel']; ?></td>
									<td><?php echo $v['bank']; ?></td>
									<td><?php echo $v['blank_count']; ?></td>
	...
	<script>
		$("#invoice_list_export").click(function(){
			load = layer.load(1);
			$.ajax({
				url:"<?php echo url('admin/Invoice/check_invoice_list_export'); ?>",
				type:"POST",
				data:{},
				success: function(data){
					if(typeof load!="undefined"){layer.close(load);}
					if (data.code == 1) {
						window.location.href="<?php echo url('admin/Invoice/invoice_list_export'); ?>";
					} else {
