<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/admin/secondary_vocat_admin_list.html";i:1525763652;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="fb-add">
				<a href="<?php echo url('admin/Admin/secondary_vocat_admin_add'); ?>">
						添加中职专业负责人
				</a>
			</div>
			<button id="btnsubmit" class="btn btn-white btn-blue btn-sm hidden-xs">批量删除</button>
			<div class="fb-export">
					<a href="<?php echo url('admin/Admin/secondary_vocat_admin_export'); ?>" title="导出所有中职负责人">
						导出所有中职负责人
					</a>
			</div>

			<div class="search-box">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/Admin/secondary_vocat_admin_list'); ?>">
			...
			<div class="col-xs-12">
				<div>
					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('/admin/Admin/admin_delall'); ?>" >
						...
						<input type="hidden" name="return_url"  value="<?php echo url('/admin/Admin/secondary_vocat_admin_list',['p' => input('p',1)]); ?>" />
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($admin_list) || $admin_list instanceof \think\Collection || $admin_list instanceof \think\Paginator): if( count($admin_list)==0 ) : echo "" ;else: foreach($admin_list as $key=>$v): ?>
								<tr>
									...
									<td class="hidden-sm hidden-xs"><?php echo $v['school_name']; ?></td>
									<td class="hidden-sm hidden-xs"><?php echo $v['major_desc']; ?></td>
									...
									<!-- <td>
										<?php if($v['admin_open'] == 1): ?>
											<a class="red open-btn" href="<?php echo url('admin/Admin/admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已开启">
												<div id="zt<?php echo $v['admin_id']; ?>"><button class="btn btn-minier btn-fb-blue">开启</button></div>
											</a>
											<?php else: ?>
											<a class="red open-btn" href="<?php echo url('admin/Admin/admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已禁用">
												<div id="zt<?php echo $v['admin_id']; ?>"><button class="btn btn-minier btn-fb-orange">禁用</button></div>
											</a>
										<?php endif; ?>
									</td> -->
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a href="<?php echo url('admin/Admin/secondary_vocat_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-edit bigger-130"></i>																</a>
											<?php if($v['admin_id'] != 1): ?>
												<a class=" confirm-rst-url-btn" data-info="确定要删除吗？" href="<?php echo url('admin/Admin/secondary_vocat_admin_del',array('admin_id'=>$v['admin_id'])); ?>" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin/Admin/secondary_vocat_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<?php if($v['admin_id'] != 1): ?>
														<li>
															<a href="<?php echo url('admin/Admin/secondary_vocat_admin_del',array('admin_id'=>$v['admin_id'])); ?>"  data-info="确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
