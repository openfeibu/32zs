<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/admin/university_admin_edit.html";i:1524576928;s:61:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/base.html";i:1524556754;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/header.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/2.0.0/app/admin/view/public/footer.html";i:1524759238;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
 ...
 -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/university_admin_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" name="admin_username" id="admin_username"  value="<?php echo $admin_list['admin_username']; ?>"  class="col-xs-10 col-sm-12" readonly/>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" name="admin_pwd" id="admin_pwd" maxlength="15" minlength="6" placeholder="输入登录密码,为空不更改" class="col-xs-10 col-sm-12" />
							<span class="lbl col-xs-12 col-sm-7"><span class="red"></span>密码必须大于6位，小于15位</span>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 负责高职专业：  </label>
						<div class="col-sm-6">
							<select name="recruit_major_id"  class="col-sm-10" id="recruit_major_id" required>
								<option value="">请选择所负责高职专业</option>
								<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
									<option value="<?php echo $v['recruit_major_id']; ?>" <?php if($v['recruit_major_id'] == $admin_list['recruit_major_id']): ?>selected<?php endif; ?>><?php echo $v['recruit_major_name']; ?></option>
					...
					<!-- <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="email" name="admin_email" id="admin_email"  value="<?php echo $admin_list['admin_email']; ?>"  class="col-xs-10 col-sm-12" required/>
