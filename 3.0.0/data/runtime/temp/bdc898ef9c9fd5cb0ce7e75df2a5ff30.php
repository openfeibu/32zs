<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/subject/subject_list.html";i:1542337187;s:61:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/base.html";i:1526927309;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/header.html";i:1527162833;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/left_nav.html";i:1524749285;s:65:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/head_nav.html";i:1524746093;s:63:"/home/vagrant/Code/32zs/3.0.0/app/admin/view/public/footer.html";i:1525328647;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div>
					<form id="score_form" name="leftnav" method="post" action="<?php echo url('admin/Score/score_active'); ?>" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tbody >
                                <?php if(is_array($subject_list) || $subject_list instanceof \think\Collection || $subject_list instanceof \think\Paginator): if( count($subject_list)==0 ) : echo "" ;else: foreach($subject_list as $key=>$v): ?>
                                <tr>
                                    <td height="28" ></td>
									<td><?php echo $v['year']; ?></td>
									<td><?php echo $v['school_name']; ?></td>
									<td><?php echo $v['major_name']; ?></td>
                                    <td><?php echo $v['subject_desc']; ?></td>
                                    <td>
                            			<div class="hidden-sm hidden-xs action-buttons">
                            				<a class="green"  href="<?php echo url('admin/subject/subject_edit',array('major_id'=>$v['major_id'],'enrollment_id'=>$v['enrollment_id'])); ?>" title="修改">
