<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/user\center.html";i:1492949211;s:79:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\head_center.html";i:1492949210;s:74:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\footer.html";i:1492949210;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script src="__PUBLIC__/layer/layer_zh-cn.js"></script>
    ...
    <div class="main w1000" style="background:#fff;">
        ...
        <div class="personal_table">
                <table width="656px">
                    ...
                    <tr>
                        ...
                        <td>考生号：<span class="GexamineeNumber"><?php echo $info['GexamineeNumber']; ?></span></td>
                        <td>填表日期：
                ...
                <table width="656px" class="k-w-table line_table">
                    <tbody><tr class="line-table-height">
                        ...
                        <td class="k-s-content low_width_4 content">
                            <input type="text" name="sex" value="<?php echo $info['sex']; ?>" valType="n" leng="18" />
                        ...
                        <td class="k-s-content low_width_7" rowspan="5" style="text-align: center;position:relative">
                                ...
                                <img  style="width: 125px; height: 175px; display: inline;" src="<?php if($user['member_list_headpic']): ?><?php echo get_imgurl($user['member_list_headpic'],1); else: ?><?php echo $yf_theme_path; ?>public/images/defaultGraph.jpg<?php endif; ?> " height="175px" width="125px"  class="headicon" data-toggle="modal" data-target="#myModal">
                    ...
                    <tr class="line-table-height">
                        ...
                        <td class="k-s-content content"><input type="text" class="noBlur" name="date" value="<?php echo $info['date']; ?>" id="birth"/></td>
        ...
        <button class="print printHide" onclick="check_preview(1)">打印</button>
        <?php else: ?>
