<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\school\major_add.html";i:1493117659;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1493127171;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1492917079;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1492917366;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1492917366;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/School/major_runadd'); ?>">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 中职学校： </label>
						<div class="col-sm-10">
							<select name="school_id" class="col-sm-4 selector" id="enrollment_school" required>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 对口高职专业： </label>
						<div class="col-sm-10">
							<select name="recruit_major_id" class="col-sm-4 selector" id="enrollment_recruit_major" required>
								<option value="">请选择高职专业</option>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 中职专业名称： </label>
						<div class="col-sm-10">
							<input type="text" name="major_name" value="" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="major_code" value="" required/>
						</div>
					</div>
					<!-- <div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 招生计划 </label>
						<div class="col-sm-10">
